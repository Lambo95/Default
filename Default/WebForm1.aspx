          ...
          <div class="row">
             <div class="text-center">
                ...
                CssClass="form-control" RepeatColumns="3" runat="server">
                    ...
                    <asp:ListItem Text="Sistema navigazione (+ 1800,00)" Value="1800"></asp:ListItem> 
                ...
                <div class="text-center">
                  <h4>Garanzia : </h4>
                    <p>Numero anni garanzia 120€/anno CAD</p>
                       <asp:DropDownList ID="Garanzia" runat="server" CssClass="form-control" AutoPostBack="true"
               >
                        <asp:ListItem Text="1 anno" Value="120"></asp:ListItem>
                        <asp:ListItem Text="2 anno" Value="240"></asp:ListItem>
                        <asp:ListItem Text="2 anno" Value="360"></asp:ListItem>
                       </asp:DropDownList>
                 </div>
               </div>
            </div>
